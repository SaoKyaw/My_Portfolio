...
const msgtxt1 = '<p class="image"><img src="img/human.png" width="61" height="61"></p><p class="text">Your Turn!</p>';
const msgtxt2 = '<p class="image"><img src="img/computer.png" width="61" height="61"></p><p class="text">Robot Turn!</p>';
const msgtxt3 = '<p class="image"><img src="img/human.png" width="61" height="61"></p><p class="text animate__animated animate__lightSpeedInRight">You save The World!!</p>';
const msgtxt4 = '<p class="image"><img src="img/computer.png" width="61" height="61"></p><p class="text animate__animated animate__lightSpeedInLeft">Robot destory The World!</p>';
const msgtxt5 = '<p class="image"><img src="img/human.png" width="61" height="61"><img src="img/computer.png" width="61" height="61"></p><p class="text animate__bounceIn">Draw!!</p>';
...
function LevelSetting(index){
    ...
    if(sessionStorage.getItem("tic_tac_toe_access")){
        switch(index){
            ...
            case 1:
                level_1.classList.add("level-selected");
                level_2.classList.add("level-noe-selected");
                level_3.classList.add("level-non-selected");
                break;
        }
    }else{
...
function isReach(status) {
    ...
    if (status === "penguins" && bearTurnEnd === "1") {
        setTimeout(() => {
            squaresBox.classList.remove("js-unclickable"); 
        }, 500); 
    }
